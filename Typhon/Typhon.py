...
def bypassMAIN(
    ...
    """
    global achievements, log_level_, generated_path, search_depth, tagged_scope, try_to_restore, reminder, string_dict, allowed_letters, is_localscope_set, allowed_int, banned_ast_, banned_chr_, banned_re_, max_length_, original_scope, int_dict, allowed_chr_, import_test, modules_test, load_module_test, interactive_
    ...
    achievements = {}  # The progress we've gone so far. Being output in the end
    generated_path = (
        {}
    ...
    def try_to_restore(
        ...
        if (
            ...
            achievements[data_name] = [current_scope[0][0], 1]
            ...
            if _:
                ...
                for i in _:
                    ...
                    if (result.__class__ == check or check is None) and (
                        ...
                        achievements[data_name] = [i, len(_)]
                        tags.append(data_name_tag)
        ...
        for module in searched_modules:
            ...
            if payload_list:
                ...
                if result:
                    ...
                    achievements[module] = [payload, len(searched_modules[module])]
...
Try to bypass blacklist with them. Please be paitent.",
            ...
            if _:
                ...
                achievements["directly input bypass"] = [_[0], len(_)]
                if print_all_payload:
                    bypasses_output(_)
                bypasses_output(_[0])
            else:
                achievements["directly input bypass"] = ["None", 0]
...
Try to bypass blacklist with them. Please be paitent.",
            ...
            if _:
                ...
                achievements["builtins set"] = [
                    builtin_dict_payload,
                    builtin_dict_found_count,
                ]
                achievements["builtins module"] = [
